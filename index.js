...
button.onclick = (e) => {
  ...
  tehilim.text.forEach((perek) => {
    perek.forEach((pasuk) => {
      if (pasuk[0] === first && pasuk[pasuk.length - 1] === last) {
        arr.push(pasuk);
      }
    });
  });
  ...
  function addListToPage() {
    arr.map((pasuk) => {
      ...
      const node = document.createTextNode(pasuk);
      para.appendChild(node);
      result_element.appendChild(para);
    });
  }
  addListToPage();
};
...
const tehilim = {
  ...
  text: [
    ...
    [
      ...
      "כצאן לשאול שתו מות ירעם וירדו בם ��שר��ם לבקר וצירם [וצורם] לבלות שאול מזבל לו",
    ...
    [
      ...
      "ויגידו שמים צדקו כי ��ל��ים שפט הוא סלה",
      "שמ��ה עמי ואדברה ישראל ואעידה בך אלהים אלהיך אנכי",
    ...
    [
      ...
      "צדיק כ��מר יפר�� כארז בלבנ��ן ישגה",
    ...
    [
      ...
      "נחלה לישראל ע��דו כי לעולם חסדו",
    ...
    [
      "מזמור לדוד יהוה קראתיך חושה לי האזינה קולי ����ראי לך",
      "��כון תפלתי קטרת לפניך משאת כפי מנחת ערב",
